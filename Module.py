...
print("==========================[Principe : Diviser pour mieux régner ]==========================")

def WriteDataToFile():
    new = "o"
    file = open("C:\\Users\\addai\python\\TP1_MPISI2.txt", "a")
    while new == "o":
...
def ReadDataFromFile():
    file = open("C:\\Users\\addai\python\\TP1_MPISI2.txt", "r")
    contents  = file.read()
    print(contents)
    file.close()
pass
